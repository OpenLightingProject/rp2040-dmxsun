...
enum Edp_Commands : uint8_t {
    ...
    DmxDataRead               = 0x11, // Poll the content of a universe
...
class Edp {
  public:
    void init(uint8_t* inData, uint8_t* scratch, uint8_t* outChunk, uint8_t patchingOffset, uint16_t maxSendChunkSize);
